...
und pusht es als `ghcr.io/noxon007/life-dash:0.3.2`, `:0.3` und `:latest`. Status
...
committen, CHANGELOG ergänzen, `git tag v0.3.3` (Bugfix) bzw. `v0.4.0`
