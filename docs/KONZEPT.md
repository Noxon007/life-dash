...
| **Wetter** | Kontext-Anreicherung (Temperatur, Bedingungen) | Historische Wetter-API anhand Zeit+Ort. Als `Metric` an verortete Events gehängt — auch nachträglich. |
...
| **P3.2** | **Dekaden-Aggregation Timeline** | M | Heat-/Dichte-Darstellung auf Jahrzehnt-/Jahres-Ebene statt langer Kartenlisten. | Übersicht bei vielen Events (wichtig, wenn Timeline-Import kommt). |
