...
**Empfohlene Reihenfolge in A** (A1–A6, A8–A13, A16, A18 sind erledigt):
Es verbleiben **A14** (Verwaltung/Admin-Aufteilung mit Reitern — macht die
Jobs-Tabelle zum eigenen Reiter) → **A7** (Modul-Vollausbau) → **A15**
(Tracking-Auswahl, braucht A7) → **A17** (Log-Ansicht).
