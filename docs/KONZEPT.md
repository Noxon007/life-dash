...
is built out to **F19** plus **F20/F21** (the baseline location and the gap
report, notes 144/145), and
...
| 145 | **Gap detection** — “eventually have at least one place for every day since birth, and let the system find the gaps”. | **Built as F21** (on `main`, 2026-08-03; the record is in [Appendix A.3](DECISIONS.md#a3-group-b--new-features-as-far-as-built)). A view, never a stored state — and a baselined day is not a gap. A view, never a stored state. |
