...
**Empfohlene Reihenfolge in A** (A1–A6, A8–A14, A16–A21, A23 sind erledigt):
Es verbleiben **A7** (Modul-Vollausbau) → **A15** (Tracking-Auswahl, braucht
A7) → **A22** (Background-Jobs, größter Brocken). Danach ist Gruppe A
